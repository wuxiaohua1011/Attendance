...
public class RetrieveAllData extends Fragment{
    ...
    private static final String[] SCOPES = { SheetsScopes.SPREADSHEETS_READONLY };
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            myView = inflater.inflate(R.layout.retrieve_all_data, container, false);
            setLayout();
            return myView;
        }

    private void setLayout() {
        mCallApiButton=(Button)myView.findViewById(R.id.activity_main_button_get_data);
        mOutputText = (TextView)myView.findViewById(R.id.activity_main_textview1);
        tableLayout = (TableLayout) myView.findViewById(R.id.activity_main_tablelayout);
        mOutputText.setMovementMethod(new ScrollingMovementMethod());
        mOutputText.setHeight(100);
